...
namespace AI_vs_I.Player.UI_Getters {
    ...
    /// <summary>
    ///     Handles displaying the player's current money.
    /// </summary>
    [ RequireComponent( typeof( Text ) ) ]
    public class PlayerMoneyGetter : CachedMonoBehaviour {
        ...
        private void SaveDataChanged( PlayerSaveData playerSaveData ) {
            Text.text = string.Format( m_displayFormat, m_saveData.Money );
        }
